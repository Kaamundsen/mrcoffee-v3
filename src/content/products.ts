/**
 * Produkter på bestillingssiden.
 * Bilder ligger i /public/produktbilder (600×600 kildefiler).
 * Rediger her for å legge til, fjerne eller endre bestillingsprodukter.
 */
